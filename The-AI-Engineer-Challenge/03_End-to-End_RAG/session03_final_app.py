"""
Session 03: Working RAG System for Vercel
=========================================
"""
...
@app.route('/')
def index():
    openai_status = '✅ Available' if OPENAI_AVAILABLE and OPENAI_API_KEY else '⚠️ Not configured'
    pdf_status = '✅ Available' if PDF_AVAILABLE else '⚠️ Not available'
...
<body>
    <div class="container">
        ...
        <div class="status warning">
            ...
            • OpenAI API: {openai_status}<br>
            • PDF Processing: {pdf_status}<br>
        ...
        <div class="upload-area" onclick="document.getElementById('fileInput').click()">
            ...
            <small>Upload a PDF to start chatting</small>
        </div>
